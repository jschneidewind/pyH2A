...
--- | --- | --- | --- | ---
Technical Operating Parameters and Specifications > Operating Capacity Factor (%) > Value | Operating Capacity Factor | value | 86% | True
Catalyst > Cost per kg ($) > Value | Catalyst Cost ($/kg) | factor | 0.1
Solar-to-Hydrogen Efficiency > STH (%) > Value | STH Efficiency | value | 27% | True
Solar Input > Mean solar input (kWh/m2/day) > Value | Solar Input (kWh/$m^{2}$/ day) | factor | 70%
